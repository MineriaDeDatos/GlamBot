...
dataset_folder = Path("/root/Desktop/NewModels/lip_model_segmentacion/Lip_Makeup_Segmentation-8")
...
data_yaml = {
    "names": ["labios_finos","labios_gruesos","labios_inferiores_gruesos","labios_pequenos","labios_superiores_gruesos"],
    "nc": 5,
    "roboflow": {
        "license": "Private",
        "project": "lip_makeup_segmentation",
        "url": "https://app.roboflow.com/ca-ioqio/lip_makeup_segmentation/8",
        "version": 8,
        "workspace": "ca-ioqio"
    },
    "train": "../train/images",
