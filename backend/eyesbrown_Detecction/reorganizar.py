...
dataset_folder = Path("/root/Downloads/eyesbrown_model/eyesbrown_model-10")
...
num_labeled_valid = int(total_labeled * 0.3)
...
num_unlabeled_valid = int(total_unlabeled * 0.3)
...
data_yaml = {
    ...
    "roboflow": {
        "license": "Private",
        "project": "eyesbrown_model-fjs0f",
        "url": "https://app.roboflow.com/ca-br0ey/eyesbrown_model-fjs0f/10",
        "version": 10,
        "workspace": "ca-br0ey"
    },
    "train": "../train/images",
